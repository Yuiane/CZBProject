...
namespace CZB.BLL
{
    public class Materials
    {
        ...
        /// 获得数据列表
        /// </summary>
        public List<CZB.Model.Material> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<CZB.Model.Material> DataTableToList(DataTable dt)
        {
            List<CZB.Model.Material> modelList = new List<CZB.Model.Material>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                CZB.Model.Material model;
