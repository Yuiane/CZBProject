...
namespace CZB.DAL.SqlServer.DataProvider
{
	...
	public partial class FX_CityParaDetails:IFX_CityParaDetails
	{
		...
		public bool Exists(int CityParaDetailsId)
		{
			...
			strSql.Append(" where CityParaDetailsId=SQL2012CityParaDetailsId");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012CityParaDetailsId", SqlDbType.Int,4)
			};
		...
		public int Add(CZB.Model.FX_CityParaDetails model)
		{
			...
			strSql.Append("SQL2012CityCode,SQL2012ParaCode,SQL2012ParaValue,SQL2012CreateTime)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012CityCode", SqlDbType.Int,4),
					new SqlParameter("SQL2012ParaCode", SqlDbType.NVarChar,50),
					new SqlParameter("SQL2012ParaValue", SqlDbType.NVarChar,50),
		...
		public bool Update(CZB.Model.FX_CityParaDetails model)
		{
			...
			strSql.Append("CityCode=SQL2012CityCode,");
			strSql.Append("ParaCode=SQL2012ParaCode,");
			strSql.Append("ParaValue=SQL2012ParaValue,");
