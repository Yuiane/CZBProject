...
namespace CZB.Web.Common
{
    public class CCCApis
    {
        ...
        public void SendToSiTeng(string postJson)
        {
            ...
            var postValue1 = "userName=dsbp&passWord=666666&clientId=AW0001";
            var _value = Utils.HttpRequestSiTeng("http://114.55.72.16/api/drp/login", RequestType.POST, postValue1);
            ...
            if (model != null && model.restCode == 0)
            {
                ...
                var _value2 = Utils.HttpRequestSiTeng("http://114.55.72.16/api/drp/addDrpRepairSheet", RequestType.POST, postValue2);
